...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2025 at 04:51 PM
...
(2, '5463434', 'Frouen', 'Dell Projector', 'BSIT');
...
(6, 'Issue logged: HEHEHE'),
(7, 'Projector ee added successfully.'),
(8, 'Projector Hello added successfully.'),
(9, 'Projector DELL PROJECTOR added successfully.'),
(10, 'Projector with ID 6 deleted successfully.'),
(11, 'Projector with ID 5 deleted successfully.'),
(12, 'Projector with ID 4 deleted successfully.'),
(13, 'Projector Dell Projector borrowed by student Frouen (5463434) for course BSIT');
...
--
ALTER TABLE `borrowing_table`
  MODIFY `borrow_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `projector_table`
  MODIFY `projector_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
